...
var senha = function senha() {
  var qtd = document.querySelector("#qtdCaracteres").value;
  var checkAddNumeros = document.querySelector("#checkAddNumeros").checked;
  var checkMaiusculas = document.querySelector("#checkMaiusculas").checked;
  var checkMinusculas = document.querySelector("#checkMinusculas").checked;
  var checkSimbolos = document.querySelector("#checkSimbolos").checked;
  return (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtd, checkAddNumeros, checkMaiusculas, checkMinusculas, checkSimbolos);
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ senhaGerada)
/* harmony export */ });
...
function senhaGerada(qte, geraMin, geraMai, geraNum, geraSimb) {
  var senhaArray = [];
  var qtd = Number(qte);
